...
<div>
    ...
    <div class="flex gap-4">
        <GradientButton
            ...
            on:click={get_full_profiles}>Refresh profiles</GradientButton
        >
                        ...
                        >
                            ...
                            <TableBodyCell>
                                {#if !["Expired", "Never Authenticated"].includes(currDate)}
                                    ...
                                    >
                                        Fresh
                                        <CheckCircleSolid class="ml-1 h-3 w-3" />
                                    </Badge>
                                {:else}
                                    <Badge
                                        color="red"
                                    ...
                                    >
                                        Stale
                                        <CloseCircleSolid class="ml-1 h-3 w-3" />
                                    </Badge>
    ...
    {#if full_profiles === undefined || !full_profiles.length}
        ...
        <p class="font-bold text-red-500 text-md">
            Your AWS config is empty, doesn't exist, or has no SSO profiles!
        </p>
    {/if}
</div>
